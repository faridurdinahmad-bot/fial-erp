        ...
        <form action="{{ route('warranties.update', $warranty) }}" method="POST">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $warranty->name) }}" required
                ...
                <div class="flex items-center gap-2">
                    ...
                    <input type="checkbox" name="status" id="status" value="1" {{ old('status', $warranty->status) ? 'checked' : '' }}
